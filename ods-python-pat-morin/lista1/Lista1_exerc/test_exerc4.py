...
class TestExerc4(unittest.TestCase):
    ...
    def test_tamanho(self):
        exerc4()
        self.arq_out.seek(0) # reposiciona o ponteiro do arquivo de saida
    ...
    def test_conteudo(self):
        exerc4()
        self.arq_out.seek(0) # reposiciona o ponteiro do arquico de saída
    ...
    def test_milhao_linhas_tam(self):
        ...
        nl1 = conta_linhas(self.arq_out)
        nl2 = 1000
        self.assertEqual(nl1, nl2, "Número de linhas diferentes do esperado")
        print("\nTeste de tamanho com milhão de linhas OK", file=sys.stderr)
